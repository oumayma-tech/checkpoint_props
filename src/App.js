...
import Photo4 from './images/photo4.jpg';
    ...
    function App() {
      ...
      return(
        <>
        <Com/>
        <Profil name={'Albert Einstein'} Profession='Physicist'  Bio='(born March 14, 1879, Ulm, Württemberg, Germany—died April 18, 1955, Princeton, New Jersey, U.S.), German-born physicist who developed the special and general theories of relativity and won the Nobel Prize for Physics in 1921 for his explanation of the photoelectric effect'   HandleName={HandleName} >
            <img  style={{ width: "300px", borderRadius: "15px",marginTop:"-29%",marginLeft:"-77%",height:"345px" }}src={Alb} alt="image"/>
           <div className="img">
